...
const socials = [
    { href: 'https://facebook.com/SlayTheBearApp',              icon: 'fab fa-facebook-f' },
    { href: 'https://twitter.com/slaythebearapp',               icon: 'fab fa-twitter' },
    { href: 'https://www.instagram.com/slaythebear',            icon: 'fab fa-instagram' },
    { href: 'https://www.linkedin.com/company/slaythebear',     icon: 'fab fa-linkedin-in' },
];
