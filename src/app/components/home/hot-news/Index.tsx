...
const hotPicks: HotPick[] = [
    { headline: 'Warns Financial Institutions To Be On Watch For Russian', topic: 'Politics', date: '27 AUGUST, 2024', time: '20 Mins' },
    { headline: 'Warns Financial Institutions To Be On Watch For Russian', topic: 'Politics', date: '27 AUGUST, 2024', time: '20 Mins' },
    { headline: 'Warns Financial Institutions To Be On Watch For Russian', topic: 'Politics', date: '27 AUGUST, 2024', time: '20 Mins' },
    { headline: 'Warns Financial Institutions To Be On Watch For Russian', topic: 'Politics', date: '27 AUGUST, 2024', time: '20 Mins' },
    { headline: 'Warns Financial Institutions To Be On Watch For Russian', topic: 'Politics', date: '27 AUGUST, 2024', time: '20 Mins' },
                            ...
                            <div key={index} className="col-lg-3">
                                <div className="editor-post-three">
                                    ...
                                    <div className="editor-post-content-three">
                                        <PostTag tagName={hotPick.topic} />
                                        <SmallPostTitle title={hotPick.headline} />
                                        <DateTime date={hotPick.date} time={hotPick.time} />
                                    </div>
                                </div>
                            </div>
                        ))}
