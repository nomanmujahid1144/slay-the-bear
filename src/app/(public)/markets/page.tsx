// src/app/(public)/markets/page.tsx
...
import { MarketDataTable } from "../../components/table/MarketDataTable";
...
export default function Markets() {
    ...
    // Popular stocks for the table
    const popularStocks = [
        'AAPL', 'MSFT', 'GOOGL', 'AMZN', 'NVDA',
        'TSLA', 'META', 'BRK.B', 'V', 'JPM'
    ];

    // Popular ETFs for the table
    const popularETFs = [
        'SPY', 'QQQ', 'IWM', 'DIA', 'VTI',
        'VOO', 'GLD', 'SLV', 'TQQQ', 'SOXL'
    ];
    ...
    useEffect(() => {
        ...
        // Keep TradingView for Crypto, Forex, Mutual Funds (Tradier doesn't support these)
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-xl-9">
                        <div className="row justify-content-center">
                            {/* STOCKS - Using Tradier MarketDataTable */}
                            ...
                            {/* CRYPTOCURRENCY - Using TradingView (Tradier doesn't support) */}
                            <div className="col-lg-12 my-3">
                            ...
                            {/* FOREX - Using TradingView (Tradier doesn't support) */}
                            <div className="col-lg-12 my-3">
                            ...
                            {/* ETFs - Using Tradier MarketDataTable */}
                            <div className="col-lg-12 my-3">
                            ...
                            {/* MUTUAL FUNDS - Using TradingView (Tradier doesn't support) */}
                            <div className="col-lg-12 my-3">
