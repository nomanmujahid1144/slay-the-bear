...
// src/app/(public)/markets/etfs/page.tsx
...
import { ETFCarouselCards } from "@/app/components/markets/etfs/ETFCarouselCards";

export default function ETFs() {
    // All ETFs to display in the main table
    const allETFs = [
        // Index ETFs
        'SPY', 'QQQ', 'IWM', 'DIA', 'VTI', 'VOO', 'VEA', 'IEFA',
        
        // Sector ETFs
        'XLK', 'XLF', 'XLE', 'XLV', 'XLI', 'XLP', 'XLY', 'XLU', 'XLB', 'XLRE', 'XLC',
        
        // International ETFs
        'VWO', 'EFA', 'EEM', 'VGK', 'IEMG', 'IXUS', 'VXUS',
        
        // Bond ETFs
        'AGG', 'BND', 'TLT', 'SHY', 'LQD', 'HYG', 'MUB', 'VCSH', 'VCIT',
        
        // Commodity ETFs
        'GLD', 'SLV', 'USO', 'DBA', 'UNG', 'PDBC', 'IAU', 'GDX',
        
        // Leveraged ETFs
        // 'TQQQ', 'SOXL', 'SQQQ', 'TNA', 'SPXL', 'TECL', 'UPRO', 'TMF',
        
        // // Growth/Value ETFs
        // 'VUG', 'VTV', 'IWF', 'IWD', 'SCHG', 'SCHV',
        
        // // Dividend ETFs
        // 'VYM', 'SCHD', 'DVY', 'SDY', 'VIG', 'DGRO',
    ];

    // Market Movers tabs configuration for ETFs
    const etfMoversTabs = [
        {
            id: 'active',
            label: 'Active',
            symbols: ['SPY', 'QQQ', 'IWM', 'DIA', 'VTI', 'XLF']
        },
        {
            id: 'gainers',
            label: 'Gainers',
            symbols: ['TQQQ', 'SOXL', 'TNA', 'SPXL', 'FAS', 'TECL']
        },
        {
            id: 'losers',
            label: 'Losers',
            symbols: ['SQQQ', 'SOXS', 'TZA', 'SPXS', 'FAZ', 'TECS']
        },
    ];
            ...
            <div className="container">
                <div className="row justify-content-center">
                    ...
                    <div className="col-xl-9">
                        <div className="sidebar-wrap">
                            {/* ETF Categories */}
                            <Heading textHeading="ETF Performance" showBtn={false} />
                            ...
                            {/* All ETFs Market Table */}
                            <Heading textHeading="All ETFs" showBtn={false} />
                            ...
                            {/* ETF News Section */}
                            <Heading textHeading="ETF News" showBtn={false} />
                            <MarketNews 
                                fetchNews={newsService.getETFsNews}
                    ...
                    <div className="col-xl-3 col-lg-8">
                        <div className="sidebar-wrap-three">
                            ...
                            {/* ETF Movers: Active | Gainers | Losers */}
                            <MarketMovers
                                tabs={etfMoversTabs}
                                defaultTab="active"
                                refreshInterval={30000}
