// src/app/purchase-success/page.js - REPLACE
                ...
                <div className="max-w-2xl w-full contact-area rounded-lg shadow-lg p-8 md:p-12">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-6 md:mb-8">
                            Thank you for subscribing to our premium service! We are thrilled to welcome you as a premium member of the SlayTheBear family. 
                            Your order <span className="font-medium hover:underline">#{subscriptionDetails.invoiceId}</span> has been successfully processed.
                            As a valued member, you now have access to exclusive calculators and advanced features.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4 sm:space-y-2 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6 md:mb-8 bg-gray-50 dark:bg-gray-800">
                        <dl className="sm:flex items-center justify-between gap-4 py-2">
                            <dt className="font-normal mb-1 sm:mb-0 text-gray-600 dark:text-gray-400">
                                Start Date
                            </dt>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            href="/profile"
                            className="btn btn-two text-center"
                        >
                            View Profile
                        </Link>
                        <Link
                            href="/"
                            className="btn btn-one text-center"
                        >
                            Return to Home
                        </Link>
                    </div>
