                    ...
                    <div>
                        <p className="text-sm my-4">
                            ...
                            <span className="font-bold">
                                <a href="https://slaythebear.com"> Slay The Bear</a>
                            </span>
                            , our web-based and mobile platform designed to empower you with tools, news, and research
                            to navigate the world of finance. Whether you&apos;re having trouble with the platform, need
                            assistance with your account, or just have a question, you&apos;ll find everything you need
                            right here.
                        </p>
                        <ol className="list-decimal">
                            <section id="getting-started">
                                ...
                                <li className="my-5">
                                    ...
                                    <ol className="list-disc">
                                        ...
                                        <li>
                                            ...
                                            <p className="text-sm my-1">
                                                How to customize your settings for a personalized experience across devices.
                                            </p>
                                        </li>
                                    </ol>
                                </li>
                                ...
                                <li className="my-5">
                                    ...
                                    <ol className="list-disc">
                                        <li>
                                            ...
                                            <p className="text-sm my-1">
                                                Trouble signing in? Visit our <Link href="/login">Sign-In</Link> Portal for assistance.
                                            </p>
                                        </li>
                                        <li>
                                            <h3 className="font-medium">Password Reset</h3>
                                            <p className="text-sm my-1">Forgotten your password? Here&apos;s how to reset it.</p>
                                        </li>
                                        <li>
                                            <h3 className="font-medium">Updating Account Information</h3>
                                            <p className="text-sm my-1">
                                                Step-by-step guide to update your profile, email, and other personal details.
                                            </p>
                                        </li>
                                    </ol>
                                </li>
                                ...
                                <li className="my-5">
                                    ...
                                    <ol className="list-disc">
                                        ...
                                        <li>
                                            ...
                                            <p className="text-sm my-1">
                                                How to access and utilize our research materials to enhance your financial knowledge.
                                            </p>
                                        </li>
                                    </ol>
                                </li>
                                ...
                                <li className="my-5">
                                    ...
                                    <ol className="list-disc">
                                        <li>
                                            ...
                                            <p className="text-sm my-1">
                                                Overview of the available subscription plans for both web and mobile users.
                                            </p>
                                        </li>
                                        <li>
                                ...
                                <li className="my-5">
                                    ...
                                    <ol className="list-disc">
                                        <li>
                                            ...
                                            <p className="text-sm my-1">
                                                Tips to resolve common issues like slow performance or bugs on both web and mobile.
                                            </p>
                                        </li>
                                        <li>
                                            <h3 className="font-medium">Tool Errors</h3>
                                            <p className="text-sm my-1">What to do if a tool isn&apos;t working correctly.</p>
                                        </li>
                                        <li>
                                            <h3 className="font-medium">News Feed Problems</h3>
                                            <p className="text-sm my-1">How to refresh your news feed or fix loading issues.</p>
                                        </li>
                                    </ol>
                                </li>
                                <hr />
                                <li className="my-5">
                                    ...
                                    <p className="text-sm my-1">Still need help? Our support team is here to assist you.</p>
                                    <ol className="list-disc">
                                        <li>
                                            <h3 className="font-medium">Email Support</h3>
                                            <p className="text-sm my-1">
                                                Reach out to us at{' '}
                                                <a href="mailto:support@slaythebear.com">support@slaythebear.com</a>.
                                            </p>
                                        </li>
                                        <li>
                                ...
                                <li className="my-5">
                                    ...
                                    <p className="text-sm my-1">
                                        Access your account, manage your subscriptions, and explore personalized content by{' '}
                                        <Link href="/login">signing in here</Link>.
                                    </p>
                                </li>
                            </section>
                        </ol>
                        ...
                        <p className="text-sm my-5">
                            ...
                            journey. If you have any suggestions on how we can improve our service, please don&apos;t hesitate
                            to <a href="mailto:support@slaythebear.com">contact us</a>.
                        </p>
                    </div>
                </div>
            </div>
